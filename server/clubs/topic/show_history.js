...
module.exports = function (N, apiPath) {
  ...
  N.wire.before(apiPath, async function fetch_topic(env) {
    let topic = await N.models.clubs.Topic.findById(env.params.topic_id).lean(true);
  ...
  function sanitize_topic(topic) {
    ...
    if (topic.st === N.models.clubs.Topic.statuses.HB) {
  ...
  N.wire.on(apiPath, async function get_topic_history(env) {
    let history = await N.models.clubs.TopicHistory.find()

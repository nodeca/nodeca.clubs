// Reflection helper for `internal:clubs.post_list`:
//
...
// Needed in:
//
// - `clubs/topic/topic.js`
// - `clubs/topic/list/by_range.js`
//
'use strict';
...
module.exports = function (N) {
  ...
  // Shortcut
  const Post = N.models.clubs.Post;
  ...
  return async function buildPostHids(env) {
    ...
    env.data.posts_hids = posts.map(x => x.hid);
  };
};

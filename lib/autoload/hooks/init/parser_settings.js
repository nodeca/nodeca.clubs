// Create parser settings for clubs application. Use `markup` schema as template.
//
...
module.exports = function (N) {
  N.wire.before('init:models', function init_clubs_parser_settings() {
    const SETTINGS_PREFIX = 'clubs_';
    const CATEGORY_KEY = 'clubs_posts_markup';
    const GROUP_KEY = 'clubs_editor';
